...
mdLinks('C:/Users/HP/OneDrive/Escritorio/bog001-md-links/bin', {validate: true}).then(links => console.log(links));
...
//mdLinks('C:/Users/HP/OneDrive/Escritorio/bog001-md-links/bin/images/MD-Links Flowchart.pdf').then(links=>console.log(links)).catch(error=> 'algún mensaje de error');
//mdLinks('./')
